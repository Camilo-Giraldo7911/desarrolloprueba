          ...
          return (
            <div className="item-container-home" key={item.id}>
              ...
              <p className="items-home-info">
                Descripcion Curso: <b>{item.description}</b>{" "}
              </p>
              <p className="items-home-info">
      ...
      <div className="container__home">
        ...
        >
          <div className="col-xl-12">
            <h4>Contacte al Profesor del Curso(s)</h4>
            <hr />
            <p>
              No olvide incluir el nombre del curso al que se Inscribio
            </p>
